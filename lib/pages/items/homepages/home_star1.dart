...
class HomeStar1 extends StatefulWidget {
  const HomeStar1({super.key});

  @override
  State<HomeStar1> createState() => _HomeStar1State();
}

class _HomeStar1State extends State<HomeStar1> {
