...
class HomeType3 extends StatefulWidget {
  const HomeType3({super.key});

  @override
  State<HomeType3> createState() => _HomeType3State();
}

class _HomeType3State extends State<HomeType3> {
