...
class HomeType2 extends StatefulWidget {
  const HomeType2({super.key});

  @override
  State<HomeType2> createState() => _HomeType2State();
}

class _HomeType2State extends State<HomeType2> {
  ...
  Stream<List<FoodReview>> readFood() => FirebaseFirestore.instance
      ...
      .where('type', isEqualTo: 'Side Dish')
      .snapshots()
      .map(
