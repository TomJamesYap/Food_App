...
class HomeType1 extends StatefulWidget {
  const HomeType1({super.key});

  @override
  State<HomeType1> createState() => _HomeType1State();
}

class _HomeType1State extends State<HomeType1> {
  ...
  Stream<List<FoodReview>> readFood() => FirebaseFirestore.instance
      ...
      .where('type', isEqualTo: 'Main Dish')
      .snapshots()
      .map(
