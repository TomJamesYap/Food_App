...
class HomePrice1 extends StatefulWidget {
  const HomePrice1({super.key});

  @override
  State<HomePrice1> createState() => _HomePrice1State();
}

class _HomePrice1State extends State<HomePrice1> {
  var sales = double.parse('999');
  @override
