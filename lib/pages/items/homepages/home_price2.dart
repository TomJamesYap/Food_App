...
class HomePrice2 extends StatefulWidget {
  const HomePrice2({super.key});

  @override
  State<HomePrice2> createState() => _HomePrice2State();
}

class _HomePrice2State extends State<HomePrice2> {
