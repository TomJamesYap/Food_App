...
class _HomePageState extends State<HomePage> {
  ...
  Stream<List<FoodReview>> readFood() =>
      FirebaseFirestore.instance.collection('FoodReview').snapshots().map(
...
//     await FirebaseFirestore.instance.collection('FoodReview').get().then(
